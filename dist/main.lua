...
local ____exports = {}
local lib = require("lua_modules.@zamiell.tstl-module.dist.main")
for ____, value in __TS__Iterator(lib.moduleSet:values()) do
    print("Inside Lua normal code, set value is:", value)
end
return ____exports
 end,
["lua_modules.@zamiell.tstl-module.dist.main"] = function(...) 
local ____lualib = require("lua_modules.@zamiell.tstl-module.dist.lualib_bundle")
...
["lua_modules.@zamiell.tstl-module.dist.lualib_bundle"] = function(...) 
local function __TS__ArrayIsArray(value)
    return type(value) == "table" and (value[1] ~= nil or next(value) == nil)
end
